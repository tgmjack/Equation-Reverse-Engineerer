        ...
        try:
            ...
            for m in range(len(self.outer_bracket_chunks.mid_brackets)):
                ...
                for i in range(len(self.outer_bracket_chunks.mid_brackets[m].inner_brackets)):
                    ...
                    #        print(str(m)+" m "+ str(i)+" i "+ str(inner_index)+ "     inner_index                 inner var = "+str(inner_var) + "     index ="+str(index))
        ...
        #        print("layer 2  below ")
         #       print(n.describe_neuron(True))
            ...
            if this_rmse < 1:
                ...
                finaldf.to_csv( str(proc)+ " = proc num          ,   extra info ere for something amazing .csv")
