...
##### see how long it takes a custom neuron with v = at    to become v = u+at      ###### need to add mid terms n outer terms
##### how am i getting good data with bad polynomials n constants
       ...
       #     for n in layer2.neurons:
        ...
        #    this_best_neuron.describe_neurons_evolution();
            ...
            if this_rmse < 1:
                ...
                finaldf.to_csv(str(dt)+" good_data  .csv")
                print("saved")
                print(9/0)
    #    except:
    #        print(" big fail ")
